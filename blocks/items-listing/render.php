<?php
/**
 * Items Listing Block - Server-Side Render
 *
 * Renders the items listing block with SSR for the first page.
 *
 * @package Aucteeno
 * @since 1.0.0
 *
...
$instance = wp_unique_id( 'aucteeno-items-' );

// Get SSR first page via Fragment Renderer.
$result = Fragment_Renderer::items(
	array(
		'location'   => $attrs['defaultLocations'],
		'auction_id' => $attrs['auctionId'],
		'page'       => 1,
...
$wrapper_attributes = get_block_wrapper_attributes(
	array(
		'class'                  => 'aucteeno-listing aucteeno-items-listing',
		'data-wp-interactive'    => 'aucteeno/listings',
		'data-aucteeno-instance' => $instance,
		'data-aucteeno-kind'     => 'items',
