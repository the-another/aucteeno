 ...
 *
 * Custom template for item products that opens the external link in a new tab.
 *
 * @package Aucteeno
 * @since 1.0.0
 */
...
<form class="cart" action="<?php echo esc_url( $product_url ); ?>" method="get" target="_blank" rel="noopener noreferrer">
